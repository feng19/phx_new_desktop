defmodule PhxNewDesktopWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PhxNewDesktopWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PhxNewDesktopWeb.Gettext, "errors", msg, opts)
    # end
